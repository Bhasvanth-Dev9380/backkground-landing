      ...
      <div id="hero-interactive-framework" className="absolute top-0 hidden h-[838px] w-full -translate-x-1/3 translate-y-20 scale-[0.5] md:-top-20 md:-translate-x-1/4 md:translate-y-8 md:scale-[0.94] lg:translate-x-0 lg:translate-y-0 md:block">
        <div className="h-[838px] w-full" style={{ opacity: 1 }}>
          <div className="absolute top-[120px] left-[calc(50%-600px)] h-[1095px] w-[1580px] -rotate-30 skew-x-30">
            ...
            {/* User icon card */}
            <div className="absolute top-[297px] left-[calc(50%-89px)] z-20 flex h-12 w-12 items-center justify-center rounded-md border border-[#E8A020] shadow-[-4px_4px_0px_0px_rgba(255,140,0,0.25)] transition-all duration-500 ease-out hover:border-[#FF8C00] hover:shadow-[-4px_4px_0px_0px_#FF6600]" style={{ backgroundColor: "#ffffff", transform: "none" }}>
            ...
            <div className="pointer-events-none absolute top-1/2 left-1/2 z-20 h-full w-full max-w-7xl -translate-x-1/2 -translate-y-1/2">
              ...
              <svg className="pointer-events-none absolute top-0 left-0 h-full w-full">
                <defs>
                  <linearGradient id="_r_ir_" gradientUnits="objectBoundingBox" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(0.14542044792931447, 0.5, 0.5)">
                    ...
                    <stop offset="35%" stopColor="rgba(255,140,0,0.12)" />
                    <stop offset="50%" stopColor="#FF6600" />
                    <stop offset="65%" stopColor="rgba(255,140,0,0.12)" />
                    <stop offset="100%" stopColor="rgba(255,140,0,0.12)" />
                    <animateTransform attributeName="gradientTransform" type="translate" additive="sum" begin="0s" from="-3 0" to="3 0" dur="2s" repeatCount="indefinite" restart="whenNotActive" />
                  </linearGradient>
                </defs>
                <path d="M600,328 L994,329" stroke="url(#_r_ir_)" strokeWidth="3" fill="none" strokeLinecap="round" pathLength={1} strokeDashoffset="0px" strokeDasharray="1px 1px" />
              </svg>
              ...
              <svg className="pointer-events-none absolute top-0 left-0 h-full w-full">
                <defs>
                  <linearGradient id="_r_is_" gradientUnits="objectBoundingBox" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(179.85457955207067, 0.5, 0.5)">
                    ...
                    <stop offset="65%" stopColor="rgba(255,140,0,0.12)" />
                    <stop offset="100%" stopColor="rgba(255,140,0,0.12)" />
                    <animateTransform attributeName="gradientTransform" type="translate" additive="sum" begin="3s" from="-3 0" to="3 0" dur="2s" repeatCount="indefinite" restart="whenNotActive" />
                  </linearGradient>
                </defs>
                <path d="M994,321 L600,322" stroke="url(#_r_is_)" strokeWidth="3" fill="none" strokeLinecap="round" pathLength={1} strokeDashoffset="0px" strokeDasharray="1px 1px" />
              </svg>
              ...
              <svg className="pointer-events-none absolute top-0 left-0 h-full w-full">
                <defs>
                  <linearGradient id="_r_it_" gradientUnits="objectBoundingBox" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(146.30993247402023, 0.5, 0.5)">
                    ...
                    <stop offset="65%" stopColor="rgba(255,140,0,0.12)" />
                    <stop offset="100%" stopColor="rgba(255,140,0,0.12)" />
                    <animateTransform attributeName="gradientTransform" type="translate" additive="sum" begin="0.5s" from="-3 0" to="3 0" dur="2s" repeatCount="indefinite" restart="whenNotActive" />
                  </linearGradient>
                </defs>
                <path d="M1020,350 L1020,477 Q1020,485 1012,485 L773,485 Q765,485 765,493 L765,520" stroke="url(#_r_it_)" strokeWidth="3" fill="none" strokeLinecap="round" pathLength={1} strokeDashoffset="0px" strokeDasharray="1px 1px" />
              </svg>
              ...
              <svg className="pointer-events-none absolute top-0 left-0 h-full w-full">
                <defs>
                  <linearGradient id="_r_iu_" gradientUnits="objectBoundingBox" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(89.59075139196507, 0.5, 0.5)">
                    ...
                    <stop offset="65%" stopColor="rgba(255,140,0,0.12)" />
                    <stop offset="100%" stopColor="rgba(255,140,0,0.12)" />
                    <animateTransform attributeName="gradientTransform" type="translate" additive="sum" begin="1s" from="-3 0" to="3 0" dur="2s" repeatCount="indefinite" restart="whenNotActive" />
                  </linearGradient>
                </defs>
                <path d="M760,550 L760,629.5 Q760,630 760.5,630 L760.5,630 Q761,630 761,630.5 L761,690" stroke="url(#_r_iu_)" strokeWidth="3" fill="none" strokeLinecap="round" pathLength={1} strokeDashoffset="0px" strokeDasharray="1px 1px" />
              </svg>
              ...
              <svg className="pointer-events-none absolute top-0 left-0 h-full w-full">
                <defs>
                  <linearGradient id="_r_iv_" gradientUnits="objectBoundingBox" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(0.3274008908443882, 0.5, 0.5)">
                    ...
                    <stop offset="65%" stopColor="rgba(255,140,0,0.12)" />
                    <stop offset="100%" stopColor="rgba(255,140,0,0.12)" />
                    <animateTransform attributeName="gradientTransform" type="translate" additive="sum" begin="1.5s" from="-3 0" to="3 0" dur="2s" repeatCount="indefinite" restart="whenNotActive" />
                  </linearGradient>
                </defs>
                <path d="M765,685 L940,686" stroke="url(#_r_iv_)" strokeWidth="3" fill="none" strokeLinecap="round" pathLength={1} strokeDashoffset="0px" strokeDasharray="1px 1px" />
              </svg>
              ...
              <svg className="pointer-events-none absolute top-0 left-0 h-full w-full">
                ...
                <path d="M1020,700 L1020.9360020479018,817.0002559877126 Q1021,825 1013,825 L950,825" stroke="rgba(255,140,0,0.12)" strokeWidth="3" fill="none" strokeLinecap="round" pathLength={1} strokeDashoffset="0px" strokeDasharray="1px 1px" />
              </svg>
              ...
              <svg className="pointer-events-none absolute top-0 left-0 h-full w-full">
                <defs>
                  <linearGradient id="_r_j1_" gradientUnits="objectBoundingBox" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(-89.23610153907002, 0.5, 0.5)">
                    ...
                    <stop offset="65%" stopColor="rgba(255,140,0,0.12)" />
                    <stop offset="100%" stopColor="rgba(255,140,0,0.12)" />
                    <animateTransform attributeName="gradientTransform" type="translate" additive="sum" begin="2s" from="-3 0" to="3 0" dur="2s" repeatCount="indefinite" restart="whenNotActive" />
                  </linearGradient>
                </defs>
                <path d="M1025,625 L1025,608 Q1025,600 1025.1599680095967,592.00159952016 L1026,550" stroke="url(#_r_j1_)" strokeWidth="3" fill="none" strokeLinecap="round" pathLength={1} strokeDashoffset="0px" strokeDasharray="1px 1px" />
              </svg>
              ...
              <svg className="pointer-events-none absolute top-0 left-0 h-full w-full">
                <defs>
                  <linearGradient id="_r_j2_" gradientUnits="objectBoundingBox" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(-90.5729386976835, 0.5, 0.5)">
                    ...
                    <stop offset="65%" stopColor="rgba(255,140,0,0.12)" />
                    <stop offset="100%" stopColor="rgba(255,140,0,0.12)" />
                    <animateTransform attributeName="gradientTransform" type="translate" additive="sum" begin="2.5s" from="-3 0" to="3 0" dur="2s" repeatCount="indefinite" restart="whenNotActive" />
                  </linearGradient>
                </defs>
                <path d="M1030,550 L1028,350" stroke="url(#_r_j2_)" strokeWidth="3" fill="none" strokeLinecap="round" pathLength={1} strokeDashoffset="0px" strokeDasharray="1px 1px" />
              </svg>
              ...
              {/* WebRTC pill */}
              <div className="absolute top-[314px] left-[calc(50%+180px)] z-20 rounded-full border border-[#E8A020] bg-white px-2 py-0.5 text-[10px] text-[#333] transition-all duration-500 ease-out">
            ...
            <div className="relative absolute top-[289px] left-[calc(50%+17px)] z-20 text-[#333]" style={{ transformStyle: "preserve-3d" }}>
              ...
              <div className="absolute" style={{ opacity: 1, zIndex: 10, transform: "translateY(0px) translateX(0px)" }}>
                <div className="flex h-12 w-12 items-center justify-center rounded-md border border-[#E8A020] px-3 py-3 shadow-[-4px_4px_0px_0px_rgba(255,140,0,0.25)] transition-all duration-500 ease-out hover:border-[#FF8C00] hover:shadow-[-4px_4px_0px_0px_#FF6600]" style={{ backgroundColor: "#ffffff", transform: "none" }}>
                  <div className="relative flex items-center justify-center" style={{ opacity: 1 }}>
            ...
            <div className="relative absolute top-[520px] left-[calc(50%+100px)] z-20" style={{ transformStyle: "preserve-3d" }}>
              ...
              <div className="absolute" style={{ opacity: 0, zIndex: 10, transform: "translateY(-8px) translateX(32px)" }}>
                <div className="flex h-12 w-12 items-center justify-center rounded-md border border-[#E8A020] p-3 shadow-[-4px_4px_0px_0px_rgba(255,140,0,0.25)] transition-all duration-500 ease-out hover:border-[#FF8C00] hover:shadow-[-4px_4px_0px_0px_#FF6600]" style={{ backgroundColor: "#ffffff", transform: "none" }}>
                  <div className="relative flex items-center justify-center" style={{ opacity: 1 }}>
            ...
            {/* Database card */}
            <div className="absolute top-[792px] left-[calc(50%+258px)] z-20 flex h-[50px] w-[50px] items-center justify-center rounded-md border border-[#E8A020] shadow-[-4px_4px_0px_0px_rgba(255,140,0,0.25)] transition-all duration-500 ease-out hover:border-[#FF8C00] hover:shadow-[-4px_4px_0px_0px_#FF6600]" style={{ backgroundColor: "#ffffff", transform: "none" }}>
              <div className="relative flex items-center justify-center" style={{ opacity: 1 }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="presentation" className="h-5 w-5 text-[#FF8C00]">
            ...
            {/* Business Logic card */}
            <div className="absolute top-[600px] left-[calc(50%+300px)] z-20 flex items-center justify-center rounded-md border border-[#E8A020] shadow-[-4px_4px_0px_0px_rgba(255,140,0,0.25)] transition-all duration-500 ease-out hover:border-[#FF8C00] hover:shadow-[-4px_4px_0px_0px_#FF6600]" style={{ backgroundColor: "#ffffff", transform: "none" }}>
              <div className="relative flex items-center justify-center" style={{ opacity: 1 }}>
            ...
            <div className="absolute top-[268px] left-[1043px] flex h-[150px] w-[250px] flex-col items-center justify-center gap-2 rounded border border-dashed border-[#E8A020] bg-white transition-colors">
              ...
              <div className="relative z-20 flex items-center justify-center rounded-md border border-[#E8A020] px-3 py-1.5 text-xs text-[#333] shadow-[-4px_4px_0px_0px_rgba(255,140,0,0.25)] transition-all duration-500 ease-out hover:border-[#FF8C00] hover:shadow-[-4px_4px_0px_0px_#FF6600]" style={{ backgroundColor: "#ffffff", transform: "none" }}>
                <div className="relative flex items-center justify-center" style={{ opacity: 1 }}>
              ...
              <div className="absolute -top-[70px] left-1 z-0 flex h-12 w-12 items-center justify-center rounded-md border border-[#E8A020] shadow-[-4px_4px_0px_0px_rgba(255,140,0,0.25)] transition-all duration-500 ease-out hover:border-[#FF8C00] hover:shadow-[-4px_4px_0px_0px_#FF6600]" style={{ backgroundColor: "#ffffff", transform: "none" }}>
                <div className="relative flex items-center justify-center" style={{ opacity: 1 }}>
            ...
            <div className="absolute top-[470px] left-[calc(50%+160px)] z-20 flex items-center justify-center rounded-md border border-[#E8A020] px-3 py-1.5 text-xs text-[#333] shadow-[-4px_4px_0px_0px_rgba(255,140,0,0.25)] transition-all duration-500 ease-out hover:border-[#FF8C00] hover:shadow-[-4px_4px_0px_0px_#FF6600]" style={{ backgroundColor: "#ffffff", transform: "none" }}>
              <div className="relative flex items-center justify-center" style={{ opacity: 1 }}>
            ...
            <div className="absolute top-[600px] left-[calc(50%+30px)] z-20 flex items-center justify-center rounded-md border border-[#E8A020] px-3 py-1.5 text-xs text-[#333] shadow-[-4px_4px_0px_0px_rgba(255,140,0,0.25)] transition-all duration-500 ease-out hover:border-[#FF8C00] hover:shadow-[-4px_4px_0px_0px_#FF6600]" style={{ backgroundColor: "#ffffff", transform: "none" }}>
              <div className="relative flex items-center justify-center" style={{ opacity: 1 }}>
                <div className="flex items-center justify-center" style={{ opacity: 1 }}>
                  <div className="mr-1">
            ...
            <div className="absolute top-[450px] left-[calc(50%-95px)] z-[5] flex h-[300px] w-[597px] px-3 py-2" style={{ opacity: 1, backgroundColor: "rgba(247, 247, 247, 0.85)", backdropFilter: "blur(6px)" }}>
              <a href="https://docs.livekit.io/agents" target="_blank" rel="noopener noreferrer" className="group h-fit self-start text-[#555] hover:text-[#FF6600] hover:underline">
                <span className="flex gap-1 font-mono text-xs uppercase tracking-widest" style={{ opacity: 1 }}>
                  Agents Framework
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="presentation" className="h-4 w-4 text-[#999] group-hover:text-[#FF6600]">
              ...
              <svg className="pointer-events-none absolute top-0 left-0 h-full w-full">
                <defs>
                  <linearGradient id="_r_j3_" gradientUnits="objectBoundingBox" x1="0%" y1="0%" x2="100%" y2="0%" gradientTransform="rotate(0, 0.5, 0.5)">
                    <stop offset="0%" stopColor="rgba(255,140,0,0.2)" />
                    <stop offset="35%" stopColor="rgba(255,140,0,0.2)" />
                    <stop offset="50%" stopColor="#FF6600" />
                    <stop offset="65%" stopColor="rgba(255,140,0,0.2)" />
                ...
                <path d="M298,1 L592,1 Q596,1 596,5 L596,293 Q596,297 592,297 L5,297 Q1,297 1,293 L1,5 Q1,1 5,1 L298,1" stroke="url(#_r_j3_)" strokeWidth="2" fill="none" strokeLinecap="round" pathLength={1} strokeDashoffset="0px" strokeDasharray="1px 1px" />
              </svg>
            </div>
